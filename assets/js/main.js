...
const instructFollowing = [
  ...
  ["IF-02", "DSD", "以温和的音色叙述往事,语气轻松且带有丝丝怀旧,女性中高音调略微降低,语速较慢,音量适中,突出青年女性感恩与轻松的特质,整体表达清晰而流畅。", "我在颁奖台上，我就跟底下观众还有我的粉丝，我就说我最要感谢的就是大树咖啡厅，我最要感谢的人就是猴子哥。你说那个时候咱这咖啡厅还愁咖啡卖不出去吗？"],
  ...
  ["IF-04", "DSD", "声音应体现出自信直接的中年女性特征,语速快慢有致,表达清晰。采用标准普通话,高音区,说话时语气肯定,并在结尾带有反问意味。", "我就是看在你是叮当老爷的份儿上。我这还坐下来跟你说话，懂吗？"],
  ["IF-05", "DSD", "以中老年男性的角色特点为基础,音色沉稳自然,表达流畅无停顿,使用标准普通话,语速舒缓,句末语调略降,分享经验时保持自信而平静的语气。", "要说这行，我比你多干了几年，对待顾客是有窍门的。"],
  ["IF-06", "RP", "在法庭上,控诉者愤怒质问对方。", "你不用说了，你就是想开小差怕困难贪图享受，我绝不是光为自己。"],
